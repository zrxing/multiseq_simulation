...
##' @param over.dispersion over.dispersion as defined by var=mu*(1-mu)*over.dispersion, which is equivalent to 1/(alpha+beta+1)
##' @return a list of alpha and beta 
estBetaParams <- function(mu.orig, over.dispersion) {
